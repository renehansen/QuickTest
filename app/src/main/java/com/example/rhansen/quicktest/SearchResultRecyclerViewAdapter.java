...
import com.example.rhansen.quicktest.dummy.DummyContent.DummyItem;
...
public class SearchResultRecyclerViewAdapter extends RecyclerView.Adapter<SearchResultRecyclerViewAdapter.ViewHolder> {
    ...
    public SearchResultRecyclerViewAdapter(List<DummyItem> items, SearchResultFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
